...
export default function AddTaskForm() {
    ...
    const [showPhaseDropdown, setShowPhaseDropdown] =
        useState(false);

    const [showAddPhase, setShowAddPhase] =
        useState(false);

    const [showMilestoneDropdown, setShowMilestoneDropdown] =
        useState(false);

    const [showAddMilestone, setShowAddMilestone] =
        useState(false);

    const [showTaskDropdown, setShowTaskDropdown] =
        useState(false);

    const [showAddTask, setShowAddTask] =
        useState(false);
    const [showSubTaskDropdown, setShowSubTaskDropdown] =
        useState(false);
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            ...
            if (
                phaseRef.current &&
                !phaseRef.current.contains(event.target)
            ) {
  ...
  "
    ...
    "
                            >
                                ...
                                <ChevronDown
                                    size={18}
                                    className={`transition-transform ${showPhaseDropdown
                                        ? "rotate-180"
                                        : ""
                                        }`}
                                />
    ...
    "
                            >
                                ...
                                <ChevronDown
                                    size={18}
                                    className={`transition-transform ${showTaskDropdown
                                        ? "rotate-180"
                                        : ""
                                        }`}
                                />
    ...
    "
                            >
                                ...
                                <ChevronDown
                                    size={18}
                                    className={`transition-transform ${showSubTaskDropdown
                                        ? "rotate-180"
                                        : ""
                                        }`}
                                />
